...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f8f9fa; border-radius: 8px; padding: 30px; margin-bottom: 20px;">
        <h1 style="color: #1e293b; margin-top: 0;">New Comment Added</h1>
        
        <p>Hello <strong>{{ $ticket->assignedUser ? $ticket->assignedUser->name : 'Team' }}</strong>,</p>
        
        <p>A new comment has been added to ticket #{{ $ticket->ticket_number }}.</p>
        
        <div style="background-color: #ffffff; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ $ticketUrl }}" style="display: inline-block; background-color: #f59e0b; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 6px; font-weight: bold;">
                View Ticket
            </a>
        </div>
    </div>
