...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f8f9fa; border-radius: 8px; padding: 30px; margin-bottom: 20px;">
        <h1 style="color: #1e293b; margin-top: 0;">Ticket Assigned</h1>
        
        <p>Hello <strong>{{ $assignedTo->name }}</strong>,</p>
        
        <p>A support ticket has been assigned to you{{ $assignedBy ? ' by ' . $assignedBy->name : '' }}.</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ $ticketUrl }}" style="display: inline-block; background-color: #10b981; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 6px; font-weight: bold;">
