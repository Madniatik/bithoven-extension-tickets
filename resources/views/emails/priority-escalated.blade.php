...
<head>
    ...
    <title>Priority Escalated</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f8f9fa; border-radius: 8px; padding: 30px; margin-bottom: 20px;">
        <h1 style="color: #1e293b; margin-top: 0;">Priority Escalated</h1>
        
        <p>Hello Team,</p>
        
        <p>The priority of ticket #{{ $ticket->ticket_number }} has been escalated and requires immediate attention.</p>
        
        <div style="background-color: #ffffff; border-left: 4px solid #ef4444; padding: 15px; margin: 20px 0; border-radius: 4px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ $ticketUrl }}" style="display: inline-block; background-color: #ef4444; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 6px; font-weight: bold;">
                View Ticket
            </a>
        </div>
    </div>
